...
$('#subMenuMovie').on('mouseleave', function() {
    $('#subMenuMovie').hide();
})
...
$('#subMenuSerial').on('mouseover', function() {
    $('.searchMovie').slideUp(50);
    $('.searchBtn').show();
    $('.XBtn').hide();
    $('#subMenuSerial').show();
...
$('#subMenuSerial').on('mouseleave', function() {
    $('#subMenuSerial').hide();
})
...
$('#subMenuPeople').on('mouseover', function() {
    $('.searchMovie').slideUp(50);
    $('.searchBtn').show();
    $('.XBtn').hide();
    $('#subMenuPeople').show();
...
$('#subMenuPeople').on('mouseleave', function() {
    $('#subMenuPeople').hide();
})
...
$('#subMenuElse').on('mouseover', function() {
    $('.searchMovie').slideUp(50);
    $('.searchBtn').show();
    $('.XBtn').hide();
    $('#subMenuElse').show();
...
$('#subMenuPlus').on('mouseover', function() {
    $('.searchMovie').slideUp(50);
    $('.searchBtn').show();
    $('.XBtn').hide();
    $('#subMenuPlus').show();
...
$('#subMenuPlus').on('mouseleave', function() {
    $('#subMenuPlus').hide();
})
